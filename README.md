<!-- mcp-name: CSOAI-ORG/sentiment-analysis-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/sentiment-analysis-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/sentiment_analysis_ai_mcp/)
...
npx -y @smithery/cli@latest install sentiment-analysis-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/sentiment-analysis-ai-mcp)
...
- "Use `analyze_sentiment` to …"
- "Use `batch_analyze` to …"
- "Use `compare_sentiments` to …"
